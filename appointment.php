...
<body>
   <div class="top-bar">
        ...
        <div>
            ...
            <a href="appointment_form.php">Add Appointments</a>
        </div>
    </div> <br><br><br><br>
<div class="container">
    ...
    <a href="appointment_form.php"><button class="btn btn-outline-success">Add Appointments</button></a>
                ...
                echo "<tr>
                        ...
                        <td>
                            <form method='post' style='display:inline;'>
                                ...
                                <button type='submit' name='cancel_appointment' class='btn btn-sm btn-cancel' " . ($row['status'] == 'Cancelled' ? 'disabled' : '') . ">
                                    Cancel
                                </button>
                            </form> 
                            </td>
                            ...
                            <form method='post' style='display:inline;'>
                                <input type='hidden' name='appointment_id' value='{$row['A_Id']}'>
                                <button type='submit' name='proceed_appointment' class='btn btn-sm btn-proceed' " . ($row['status'] == 'Confirmed' ? 'disabled' : '') . ">
                                    Proceed
                                </button>
                            </form>
                        </td>
