...
if ($stmt->num_rows > 0) {
    $stmt->bind_result($user_id, $stored_password, $role, $name);
    $stmt->fetch();
    ...
    if (password_verify($password, $stored_password)) {
        if ($role === "Doctor") { 
            ...
            $error = "Access denied! Only doctors can log in here.";
        }
    } else {
...
<body>
    <div class="login-container">
        ...
        <form method="POST" action="doctors_login.php">
            <div class="form-group">
                <label for="username">Username:</label>
                <input type="text" id="username" name="username" value="Lisa Molly" required>
            </div>
            <div class="form-group">
